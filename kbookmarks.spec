...
%setup -q -n kbookmarks-6.2.0
cd %{_builddir}/kbookmarks-6.2.0
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKF6Bookmarks.so.6.2.0
/V3/usr/lib64/libKF6BookmarksWidgets.so.6.2.0
/usr/lib64/libKF6Bookmarks.so.6
/usr/lib64/libKF6Bookmarks.so.6.2.0
/usr/lib64/libKF6BookmarksWidgets.so.6
/usr/lib64/libKF6BookmarksWidgets.so.6.2.0
