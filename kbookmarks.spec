...
Source0  : https://download.kde.org/stable/frameworks/5.110/kbookmarks-5.110.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.110/kbookmarks-5.110.0.tar.xz.sig
...
%prep
%setup -q -n kbookmarks-5.110.0
cd %{_builddir}/kbookmarks-5.110.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1694452649
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKF5Bookmarks.so.5.110.0
/usr/lib64/libKF5Bookmarks.so.5
/usr/lib64/libKF5Bookmarks.so.5.110.0
