...
Source0  : https://download.kde.org/stable/frameworks/5.60/kbookmarks-5.60.0.tar.xz
Source99 : https://download.kde.org/stable/frameworks/5.60/kbookmarks-5.60.0.tar.xz.sig
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1563066600
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKF5Bookmarks.so.5.60.0
