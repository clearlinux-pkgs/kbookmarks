...
Version  : 6.14.0
Release  : 97
URL      : https://download.kde.org/stable/frameworks/6.14/kbookmarks-6.14.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/6.14/kbookmarks-6.14.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/6.14/kbookmarks-6.14.0.tar.xz.sig
...
%setup -q -n kbookmarks-6.14.0
cd %{_builddir}/kbookmarks-6.14.0
pushd ..
cp -a kbookmarks-6.14.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1747070815
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKF6Bookmarks.so.6.14.0
/V3/usr/lib64/libKF6BookmarksWidgets.so.6.14.0
/usr/lib64/libKF6Bookmarks.so.6
/usr/lib64/libKF6Bookmarks.so.6.14.0
/usr/lib64/libKF6BookmarksWidgets.so.6
/usr/lib64/libKF6BookmarksWidgets.so.6.14.0
