...
Source0  : https://download.kde.org/stable/frameworks/6.1/kbookmarks-6.1.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/6.1/kbookmarks-6.1.0.tar.xz.sig
...
%setup -q -n kbookmarks-6.1.0
cd %{_builddir}/kbookmarks-6.1.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1712968954
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKF6Bookmarks.so.6.1.0
/V3/usr/lib64/libKF6BookmarksWidgets.so.6.1.0
/usr/lib64/libKF6Bookmarks.so.6
/usr/lib64/libKF6Bookmarks.so.6.1.0
/usr/lib64/libKF6BookmarksWidgets.so.6
/usr/lib64/libKF6BookmarksWidgets.so.6.1.0
