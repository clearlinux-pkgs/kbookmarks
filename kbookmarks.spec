...
Version  : 6.12.0
Release  : 95
URL      : https://download.kde.org/stable/frameworks/6.12/kbookmarks-6.12.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/6.12/kbookmarks-6.12.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/6.12/kbookmarks-6.12.0.tar.xz.sig
...
%setup -q -n kbookmarks-6.12.0
cd %{_builddir}/kbookmarks-6.12.0
pushd ..
cp -a kbookmarks-6.12.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1742413577
mkdir -p clr-build
pushd clr-build
...
/usr/share/locale/sa/LC_MESSAGES/kbookmarks6_qt.qm
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKF6Bookmarks.so.6.12.0
/V3/usr/lib64/libKF6BookmarksWidgets.so.6.12.0
/usr/lib64/libKF6Bookmarks.so.6
/usr/lib64/libKF6Bookmarks.so.6.12.0
/usr/lib64/libKF6BookmarksWidgets.so.6
/usr/lib64/libKF6BookmarksWidgets.so.6.12.0
