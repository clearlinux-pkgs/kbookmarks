...
Source0  : https://download.kde.org/stable/frameworks/6.5/kbookmarks-6.5.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/6.5/kbookmarks-6.5.0.tar.xz.sig
...
%setup -q -n kbookmarks-6.5.0
cd %{_builddir}/kbookmarks-6.5.0
pushd ..
cp -a kbookmarks-6.5.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1723227478
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKF6Bookmarks.so.6.5.0
/V3/usr/lib64/libKF6BookmarksWidgets.so.6.5.0
/usr/lib64/libKF6Bookmarks.so.6
/usr/lib64/libKF6Bookmarks.so.6.5.0
/usr/lib64/libKF6BookmarksWidgets.so.6
/usr/lib64/libKF6BookmarksWidgets.so.6.5.0
