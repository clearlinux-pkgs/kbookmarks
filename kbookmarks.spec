...
Source0  : https://download.kde.org/stable/frameworks/5.101/kbookmarks-5.101.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.101/kbookmarks-5.101.0.tar.xz.sig
...
%prep
%setup -q -n kbookmarks-5.101.0
cd %{_builddir}/kbookmarks-5.101.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1671118318
mkdir -p clr-build
pushd clr-build
